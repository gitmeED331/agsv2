...
function TrackPosition() {
	...
	return (
		<box className={"positioncontainer"} vertical={true} visible={bind(player, "length").as((length) => (length > 0 ? true : false))}>
			{positionSlider}
			<centerbox startWidget={lengthLabel} endWidget={positionLabel} />
		</box>
	);
}
